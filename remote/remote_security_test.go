...
func TestShellInjection_BuildDirWithSpecialChars(t *testing.T) {
	...
	err := client.BuildImage(context.Background(), buildDir, 1, nil, nil)
	require.NoError(t, err)
...
// TestCleanup_RejectsAbsolutePathOutsideTmp verifies /etc is rejected
func TestCleanup_RejectsAbsolutePathOutsideTmp(t *testing.T) {
	cfg := &config.Config{
		Name:   "myapp",
		Server: "testserver",
		Stack:  "/stacks/myapp",
...
func TestCleanup_RejectsPathTraversal(t *testing.T) {
	cfg := &config.Config{
		Name:   "myapp",
		Server: "testserver",
		Stack:  "/stacks/myapp",
...
func TestCleanup_RejectsRootPath(t *testing.T) {
	cfg := &config.Config{
		Name:   "myapp",
		Server: "testserver",
		Stack:  "/stacks/myapp",
...
func TestCleanup_RejectsEmptyPath(t *testing.T) {
	cfg := &config.Config{
		Name:   "myapp",
		Server: "testserver",
		Stack:  "/stacks/myapp",
...
func TestCleanup_AcceptsValidTempPath(t *testing.T) {
	cfg := &config.Config{
		Name:   "myapp",
		Server: "testserver",
		Stack:  "/stacks/myapp",
